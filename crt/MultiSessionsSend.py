...
def Main():
    ...
    sessionsFileName = os.path.expanduser(
        r"C:\Users\Administrator\Documents\crt") + "/SessionList.txt"
    ...
    for session in sessionsArray:
        ...
        if crt.Session.Connected:
            ...
            # is dynamic (e.g. changes according to current working folder,
            # etc)
    ...
    if errorMessages == "":
        ...
        crt.Dialog.MessageBox(
            "Tasks completed.  The following errors occurred:\n" +
            errorMessages)
