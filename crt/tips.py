...
def exex():
    path = r"Desktop" + "\\"
    exe = ['tipsplus2.exe', 'tipsplus2-mx.exe', 'xfinformation.exe', 'wxseasonalfresh.exe', 'ktpostnotes.exe']
...
def url_host():
    url_host = ["-dspurl=http://test.gamma-minipage.news.7654.com", "-dspurl=http://news.7654.com",
                "-dspurl=http://egg-test.7654.com", "-dspurl=http://page.nanjingchenxi.com",
                "-dspurl=http://gg.smartlook.shheshou.com", "-dspurl=http://gg.wallpaper.shqingzao.com"]
...
def argue():
    arg = " -closebuttonjsonurl=http://down1.7654browser.shzhanmeng.com/tui/close.json " \
          "-title=title_tips -classname=class_tips -reportprefix=qianzh -recordshow=1 -nopopwhenlong=1 " \
